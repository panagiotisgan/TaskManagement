...
/****** Object:  Database [TaskManagementDB]    Script Date: 9/30/2024 12:12:59 PM ******/
...
/****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 9/30/2024 12:51:57 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Logs](
	[Id] [bigint] IDENTITY(1,1) NOT NULL,
	[AssignmentId] [bigint] NOT NULL,
	[PreviousTaskState] [nvarchar](max) NOT NULL,
...
ALTER TABLE [dbo].[Logs]  WITH CHECK ADD  CONSTRAINT [FK_Logs_Assignments_AssignmentId] FOREIGN KEY([AssignmentId])
REFERENCES [dbo].[Assignments] ([Id])
ON DELETE CASCADE
GO

ALTER TABLE [dbo].[Logs] CHECK CONSTRAINT [FK_Logs_Assignments_AssignmentId]
GO
...
ALTER TABLE [dbo].[TeamUser]  WITH CHECK ADD  CONSTRAINT [FK_TeamUser_Teams_TeamId] FOREIGN KEY([TeamId])
REFERENCES [dbo].[Teams] ([Id])
ON DELETE CASCADE
GO

ALTER TABLE [dbo].[TeamUser] CHECK CONSTRAINT [FK_TeamUser_Teams_TeamId]
GO
