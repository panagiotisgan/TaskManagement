            ...
            modelBuilder.Entity("TaskManagement.Domain.Models.Log", b =>
                {
                    ...
                    b.Property<DateTime>("ModificationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 22, 14, 24, 31, 776, DateTimeKind.Utc).AddTicks(6225));
            ...
            modelBuilder.Entity("TaskManagement.Domain.Models.Comment", b =>
                {
                    ...
                    b.HasOne("TaskManagement.Domain.Models.Task", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("TaskManagement.Domain.Models.UserTask", b =>
                {
                    b.HasOne("TaskManagement.Domain.Models.Task", null)
                        .WithOne("UserTask")
                        .HasForeignKey("TaskManagement.Domain.Models.UserTask", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
